...
// #[tokio::test]
// async fn get_history_executions() {
//     let config = create_config();
//     let (ctx, _) = trade::TradeContext::try_new(config).await.unwrap();
//     let resp = ctx.history_executions(None).await.unwrap();
//     println!("{:?}", resp);
// }
...
//     let config = create_config();
//     let (ctx, _) = trade::TradeContext::try_new(config).await.unwrap();
//     let resp = ctx.account_balance().await.unwrap();
//     println!("{:?}", resp);
// }
